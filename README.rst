...
Test project to extract and display data from the electoral commission's funding data
...
To run the tests, enter the pfund/tests directory and run the following commands::
